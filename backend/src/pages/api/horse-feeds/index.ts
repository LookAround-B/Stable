    ...
    if (req.method === 'POST') {
      ...
      const record = await prisma.horseFeed.create({
        data: {
          ...
          horseId,
          date: recordDate,
          sports: sports ? parseFloat(sports) : null,
          ...
          bran: bran ? parseFloat(bran) : null,
          salt: salt ? parseFloat(salt) : null,
          dcp: dcp ? parseFloat(dcp) : null,
          epsom: epsom ? parseFloat(epsom) : null,
          riceBranOil: riceBranOil ? parseFloat(riceBranOil) : null,
          heylage: heylage ? parseFloat(heylage) : null,
          electrolyte: electrolyte ? parseFloat(electrolyte) : null,
          diggyMax: diggyMax ? parseFloat(diggyMax) : null,
