  ...
  return (
    <div className="work-records-page space-y-6">
      ...
      {showAddForm && canCreateWorkRecord && ReactDOM.createPortal(
        <div className="efm-page-modal-overlay fixed inset-0 z-[60] flex items-start justify-center overflow-y-auto bg-background/80 px-4 pb-4 pt-[78px] sm:px-6 sm:pb-6 sm:pt-[92px]" onClick={() => setShowAddForm(false)}>
