    ...
    <div className="digital-attendance-page space-y-6">
      ...
      {showForm && ReactDOM.createPortal(
        <div className="efm-page-modal-overlay fixed inset-0 z-50 flex items-start sm:items-center justify-center overflow-y-auto px-4 pb-4 pt-[72px] sm:p-6 bg-background/80" onClick={() => setShowForm(false)}>
          <div className="my-auto bg-surface-container-highest rounded-xl border border-border w-full max-w-2xl overflow-visible flex flex-col" onClick={(e) => e.stopPropagation()}>
