...
const translations = {
  ...
  "Treatment Logs":         { en: "Treatment Logs",         hi: "उपचार लॉग",               te: "చికిత్స లాగ్‌లు",               kn: "ಚಿಕಿತ್ಸಾ ಲಾಗ್‌ಗಳು" },
  ...
  "View inspection rounds and treatment logs.": { en: "View inspection rounds and treatment logs.", hi: "निरीक्षण राउंड और उपचार लॉग देखें।", te: "తనిఖీ రౌండ్లు మరియు చికిత్స లాగ్‌లను చూడండి.", kn: "ಪರಿಶೀಲನೆ ಸುತ್ತುಗಳು ಮತ್ತು ಚಿಕಿತ್ಸಾ ಲಾಗ್‌ಗಳನ್ನು ನೋಡಿ." },
...
const extraTranslations = {
  "Bookings": { en: "Bookings", hi: "बुकिंग्स", te: "బుకింగ్స్", kn: "ಬುಕಿಂಗ್‌ಗಳು" },
  "Grass & Bedding": { en: "Grass & Bedding", hi: "घास और बिछावन", te: "గడ్డి మరియు బెడ్డింగ్", kn: "ಹುಲ್ಲು ಮತ್ತು ಬೆಡ್ಡಿಂಗ್" },
  "Instructor Incentives": { en: "Instructor Incentives", hi: "प्रशिक्षक प्रोत्साहन", te: "శిక్షక ప్రోత్సాహకాలు", kn: "ಪ್ರಶಿಕ್ಷಕರ ಪ್ರೋತ್ಸಾಹಧನ" },
  "Track grass and bedding collection, load receipt, and tonnage.": { en: "Track grass and bedding collection, load receipt, and tonnage.", hi: "घास और बिछावन की एंट्री, लोड प्राप्ति और टन भार को ट्रैक करें।", te: "గడ్డి మరియు బెడ్డింగ్ సేకరణ, లోడ్ స్వీకరణ మరియు టన్నేజీని ట్రాక్ చేయండి.", kn: "ಹುಲ್ಲು ಮತ್ತು ಬೆಡ್ಡಿಂಗ್ ಸಂಗ್ರಹ, ಲೋಡ್ ಸ್ವೀಕೃತಿ ಮತ್ತು ತೂಕವನ್ನು ಟ್ರ್ಯಾಕ್ ಮಾಡಿ." },
  "Failed to load grass and bedding records": { en: "Failed to load grass and bedding records", hi: "घास और बिछावन रिकॉर्ड लोड नहीं हो सके", te: "గడ్డి మరియు బెడ్డింగ్ రికార్డులు లోడ్ కాలేదు", kn: "ಹುಲ್ಲು ಮತ್ತು ಬೆಡ್ಡಿಂಗ್ ದಾಖಲೆಗಳನ್ನು ಲೋಡ್ ಮಾಡಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ" },
  "Record updated": { en: "Record updated", hi: "रिकॉर्ड अपडेट किया गया", te: "రికార్డు నవీకరించబడింది", kn: "ದಾಖಲೆ ನವೀಕರಿಸಲಾಗಿದೆ" },
  "Record added": { en: "Record added", hi: "रिकॉर्ड जोड़ा गया", te: "రికార్డు చేర్చబడింది", kn: "ದಾಖಲೆ ಸೇರಿಸಲಾಗಿದೆ" },
  "Failed to save record": { en: "Failed to save record", hi: "रिकॉर्ड सहेजने में विफल", te: "రికార్డును సేవ్ చేయడంలో విఫలమైంది", kn: "ದಾಖಲೆಯನ್ನು ಉಳಿಸಲು ವಿಫಲವಾಗಿದೆ" },
  "Collected By": { en: "Collected By", hi: "संग्रह करने वाला", te: "సేకరించిన వ్యక్తి", kn: "ಸಂಗ್ರಹಿಸಿದವರು" },
  "Grass Load Received": { en: "Grass Load Received", hi: "घास का लोड प्राप्त", te: "గడ్డి లోడ్ అందింది", kn: "ಹುಲ್ಲಿನ ಲೋಡ್ ಸ್ವೀಕರಿಸಲಾಗಿದೆ" },
  "Weight In Tons": { en: "Weight In Tons", hi: "वजन (टन में)", te: "బరువు (టన్నుల్లో)", kn: "ತೂಕ (ಟನ್‌ಗಳಲ್ಲಿ)" },
  "Load Received": { en: "Load Received", hi: "लोड प्राप्त", te: "లోడ్ అందింది", kn: "ಲೋಡ್ ಸ್ವೀಕರಿಸಲಾಗಿದೆ" },
  "Search records...": { en: "Search records...", hi: "रिकॉर्ड खोजें...", te: "రికార్డులను వెతకండి...", kn: "ದಾಖಲೆಗಳನ್ನು ಹುಡುಕಿ..." },
  "No data": { en: "No data", hi: "कोई डेटा नहीं", te: "డేటా లేదు", kn: "ಡೇಟಾ ಇಲ್ಲ" },
  "entries": { en: "entries", hi: "एंट्रियाँ", te: "ఎంట్రీలు", kn: "ದಾಖಲೆಗಳು" },
  "No records matching": { en: "No records matching", hi: "मेल खाने वाले रिकॉर्ड नहीं", te: "సరిపోలే రికార్డులు లేవు", kn: "ಹೊಂದುವ ದಾಖಲೆಗಳು ಇಲ್ಲ" },
  "No grass or bedding records found.": { en: "No grass or bedding records found.", hi: "घास या बिछावन के रिकॉर्ड नहीं मिले।", te: "గడ్డి లేదా బెడ్డింగ్ రికార్డులు కనబడలేదు.", kn: "ಹುಲ್ಲು ಅಥವಾ ಬೆಡ್ಡಿಂಗ್ ದಾಖಲೆಗಳು ಕಂಡುಬಂದಿಲ್ಲ." },
  "Export Grass and Bedding": { en: "Export Grass and Bedding", hi: "घास और बिछावन निर्यात करें", te: "గడ్డి మరియు బెడ్డింగ్ ఎగుమతి", kn: "ಹುಲ್ಲು ಮತ್ತು ಬೆಡ್ಡಿಂಗ್ ರಫ್ತು" },
  "Export grass and bedding": { en: "Export grass and bedding", hi: "घास और बिछावन निर्यात करें", te: "గడ్డి మరియు బెడ్డింగ్ ఎగుమతి", kn: "ಹುಲ್ಲು ಮತ್ತು ಬೆಡ್ಡಿಂಗ್ ರಫ್ತು" },
  "Delete Entry": { en: "Delete Entry", hi: "एंट्री हटाएँ", te: "ఎంట్రీ తొలగించండి", kn: "ದಾಖಲೆ ಅಳಿಸಿ" },
  "Delete this grass/bedding record?": { en: "Delete this grass/bedding record?", hi: "क्या यह घास/बिछावन रिकॉर्ड हटाना है?", te: "ఈ గడ్డి/బెడ్డింగ్ రికార్డును తొలగించాలా?", kn: "ಈ ಹುಲ್ಲು/ಬೆಡ್ಡಿಂಗ್ ದಾಖಲೆ ಅಳಿಸಬೇಕೇ?" },
  "Bedding Name": { en: "Bedding Name", hi: "बिछावन का नाम", te: "బెడ్డింగ్ పేరు", kn: "ಬೆಡ್ಡಿಂಗ್ ಹೆಸರು" },
  "Grass Name": { en: "Grass Name", hi: "घास का नाम", te: "గడ్డి పేరు", kn: "ಹುಲ್ಲಿನ ಹೆಸರು" },
  "Increase weight": { en: "Increase weight", hi: "वजन बढ़ाएँ", te: "బరువు పెంచండి", kn: "ತೂಕ ಹೆಚ್ಚಿಸಿ" },
  "Decrease weight": { en: "Decrease weight", hi: "वजन घटाएँ", te: "బరువు తగ్గించండి", kn: "ತೂಕ ಕಡಿಮೆ ಮಾಡಿ" },
  "e.g. Pine Shavings": { en: "e.g. Pine Shavings", hi: "जैसे पाइन शेविंग्स", te: "ఉదా: పైన్ షేవింగ్స్", kn: "ಉದಾ: ಪೈನ್ ಶೇವಿಂಗ್ಸ್" },
  "e.g. Lucerne Grass": { en: "e.g. Lucerne Grass", hi: "जैसे लूसर्न घास", te: "ఉదా: లూసెర్న్ గడ్డి", kn: "ಉದಾ: ಲೂಸರ್ನ್ ಹುಲ್ಲು" },
  "Yes": { en: "Yes", hi: "हाँ", te: "అవును", kn: "ಹೌದು" },
  "No": { en: "No", hi: "नहीं", te: "కాదు", kn: "ಇಲ್ಲ" },
  "Stable #": { en: "Stable #", hi: "स्टेबल #", te: "స్టేబుల్ #", kn: "ಸ್ಟೇಬಲ್ #" },
  "Add Entry": { en: "Add Entry", hi: "एंट्री जोड़ें", te: "ఎంట్రీ జోడించండి", kn: "ದಾಖಲೆ ಸೇರಿಸಿ" },
  "Edit Entry": { en: "Edit Entry", hi: "एंट्री संपादित करें", te: "ఎంట్రీ సవరించండి", kn: "ದಾಖಲೆ ಸಂಪಾದಿಸಿ" },
  "Select Horse": { en: "Select Horse", hi: "घोड़ा चुनें", te: "గుర్రాన్ని ఎంచుకోండి", kn: "ಕುದುರೆಯನ್ನು ಆಯ್ಕೆ ಮಾಡಿ" },
  "Timestamp": { en: "Timestamp", hi: "समय-मुद्रा", te: "సమయ ముద్ర", kn: "ಸಮಯ ಮುದ್ರೆ" },
  "Grass": { en: "Grass", hi: "घास", te: "గడ్డి", kn: "ಹುಲ್ಲು" },
  "Bedding": { en: "Bedding", hi: "बिछावन", te: "బెడ్డింగ్", kn: "ಬೆಡ್ಡಿಂಗ್" },
  "Payment Mode": { en: "Payment Mode", hi: "भुगतान माध्यम", te: "చెల్లింపు విధానం", kn: "ಪಾವತಿ ವಿಧಾನ" },
  "Approved By": { en: "Approved By", hi: "स्वीकृत किया गया", te: "ఆమోదించినవారు", kn: "ಅನುಮೋದಿಸಿದವರು" },
  "Client Name *": { en: "Client Name *", hi: "ग्राहक का नाम *", te: "కస్టమర్ పేరు *", kn: "ಗ್ರಾಹಕ ಹೆಸರು *" },
  "Phone Number *": { en: "Phone Number *", hi: "फोन नंबर *", te: "ఫోన్ నంబర్ *", kn: "ಫೋನ್ ಸಂಖ್ಯೆ *" },
  "Total Room Price with Tax": { en: "Total Room Price with Tax", hi: "कर सहित कुल कमरे की कीमत", te: "పన్నుతో మొత్తం గది ధర", kn: "ತೆರಿಗೆಯೊಂದಿಗೆ ಒಟ್ಟು ಕೊಠಡಿ ಬೆಲೆ" },
  "Instructor (Optional)": { en: "Instructor (Optional)", hi: "प्रशिक्षक (वैकल्पिक)", te: "శిక్షకుడు (ఐచ్చికం)", kn: "ಪ್ರಶಿಕ್ಷಕ (ಐಚ್ಛಿಕ)" },
  "Booking Type *": { en: "Booking Type *", hi: "बुकिंग प्रकार *", te: "బుకింగ్ రకం *", kn: "ಬುಕಿಂಗ್ ಪ್ರಕಾರ *" },
  "Fun Ride *": { en: "Fun Ride *", hi: "मनोरंजन राइड *", te: "ఫన్ రైడ్ *", kn: "ಮನರಂಜನಾ ಸವಾರಿ *" },
  "Where To Go *": { en: "Where To Go *", hi: "कहाँ जाना है *", te: "ఎక్కడికి వెళ్లాలి *", kn: "ಎಲ್ಲಿ ಹೋಗಬೇಕು *" },
  "Horse Booking History": { en: "Horse Booking History", hi: "घोड़े की बुकिंग हिस्ट्री", te: "గుర్రపు బుకింగ్ చరిత్ర", kn: "ಕುದುರೆಯ ಬುಕಿಂಗ್ ಇತಿಹಾಸ" },
  "Package Price *": { en: "Package Price *", hi: "पैकेज कीमत *", te: "ప్యాకేజ్ ధర *", kn: "ಪ್ಯಾಕೇಜ್ ಬೆಲೆ *" },
  "GST *": { en: "GST *", hi: "GST *", te: "GST *", kn: "GST *" },
  "Check-in *": { en: "Check-in *", hi: "चेक-इन *", te: "చెక్-ఇన్ *", kn: "ಚೆಕ್-ಇನ್ *" },
  "Check-out *": { en: "Check-out *", hi: "चेक-आउट *", te: "చెక్-అవుట్ *", kn: "ಚೆಕ್-ಔಟ್ *" },
  "Save Task": { en: "Save Task", hi: "कार्य सहेजें", te: "టాస్క్ సేవ్ చేయండి", kn: "ಕಾರ್ಯ ಉಳಿಸಿ" },
  "Create Task": { en: "Create Task", hi: "कार्य बनाएँ", te: "టాస్క్ సృష్టించండి", kn: "ಕಾರ್ಯ ರಚಿಸಿ" },
  "Submit Task Evidence": { en: "Submit Task Evidence", hi: "कार्य प्रमाण जमा करें", te: "టాస్క్ సాక్ష్యం సమర్పించండి", kn: "ಕಾರ್ಯ ಸಾಕ್ಷ್ಯ ಸಲ್ಲಿಸಿ" },
  "Completion Notes": { en: "Completion Notes", hi: "समापन नोट्स", te: "పూర్తి గమనికలు", kn: "ಪೂರ್ಣಗೊಳಿಸುವ ಟಿಪ್ಪಣಿಗಳು" },
  "JPG, PNG (Max 5MB)": { en: "JPG, PNG (Max 5MB)", hi: "JPG, PNG (अधिकतम 5MB)", te: "JPG, PNG (గరిష్టం 5MB)", kn: "JPG, PNG (ಗರಿಷ್ಠ 5MB)" },
  "Track and manage instructor incentives (minimum Rs1400)": { en: "Track and manage instructor incentives (minimum Rs1400)", hi: "प्रशिक्षक प्रोत्साहनों को ट्रैक और प्रबंधित करें (न्यूनतम Rs1400)", te: "శిక్షక ప్రోత్సాహకాలను ట్రాక్ చేసి నిర్వహించండి (కనిష్టం Rs1400)", kn: "ಪ್ರಶಿಕ್ಷಕರ ಪ್ರೋತ್ಸಾಹಧನವನ್ನು ಟ್ರ್ಯಾಕ್ ಮಾಡಿ ನಿರ್ವಹಿಸಿ (ಕನಿಷ್ಠ Rs1400)" },
  "Add Incentive": { en: "Add Incentive", hi: "प्रोत्साहन जोड़ें", te: "ప్రోత్సాహకం జోడించండి", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಸೇರಿಸಿ" },
  "Edit Incentive": { en: "Edit Incentive", hi: "प्रोत्साहन संपादित करें", te: "ప్రోత్సాహకాన్ని సవరించండి", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಸಂಪಾದಿಸಿ" },
  "Instructor *": { en: "Instructor *", hi: "प्रशिक्षक *", te: "శిక్షకుడు *", kn: "ಪ್ರಶಿಕ್ಷಕ *" },
  "Date *": { en: "Date *", hi: "तारीख *", te: "తేదీ *", kn: "ದಿನಾಂಕ *" },
  "Amount (Rs) *": { en: "Amount (Rs) *", hi: "राशि (रु.) *", te: "మొత్తం (రూ.) *", kn: "ಮೊತ್ತ (ರೂ.) *" },
  "min Rs1400": { en: "min Rs1400", hi: "न्यूनतम Rs1400", te: "కనిష్టం Rs1400", kn: "ಕನಿಷ್ಠ Rs1400" },
  "Minimum Rs1400": { en: "Minimum Rs1400", hi: "न्यूनतम Rs1400", te: "కనిష్టం Rs1400", kn: "ಕನಿಷ್ಠ Rs1400" },
  "Payment Mode *": { en: "Payment Mode *", hi: "भुगतान माध्यम *", te: "చెల్లింపు విధానం *", kn: "ಪಾವತಿ ವಿಧಾನ *" },
  "Select instructor...": { en: "Select instructor...", hi: "प्रशिक्षक चुनें...", te: "శిక్షకుడిని ఎంచుకోండి...", kn: "ಪ್ರಶಿಕ್ಷಕರನ್ನು ಆಯ್ಕೆ ಮಾಡಿ..." },
  "Select payment mode...": { en: "Select payment mode...", hi: "भुगतान माध्यम चुनें...", te: "చెల్లింపు విధానాన్ని ఎంచుకోండి...", kn: "ಪಾವತಿ ವಿಧಾನ ಆಯ್ಕೆ ಮಾಡಿ..." },
  "Select month...": { en: "Select month...", hi: "महीना चुनें...", te: "నెలను ఎంచుకోండి...", kn: "ತಿಂಗಳನ್ನು ಆಯ್ಕೆ ಮಾಡಿ..." },
  "Select year...": { en: "Select year...", hi: "वर्ष चुनें...", te: "సంవత్సరాన్ని ఎంచుకోండి...", kn: "ವರ್ಷ ಆಯ್ಕೆ ಮಾಡಿ..." },
  "Number of Lessons": { en: "Number of Lessons", hi: "पाठों की संख्या", te: "పాఠాల సంఖ్య", kn: "ಪಾಠಗಳ ಸಂಖ್ಯೆ" },
  "Lessons": { en: "Lessons", hi: "पाठ", te: "పాఠాలు", kn: "ಪಾಠಗಳು" },
  "Reason for incentive...": { en: "Reason for incentive...", hi: "प्रोत्साहन का कारण...", te: "ప్రోత్సాహానికి కారణం...", kn: "ಪ್ರೋತ್ಸಾಹಧನದ ಕಾರಣ..." },
  "Additional notes...": { en: "Additional notes...", hi: "अतिरिक्त टिप्पणियाँ...", te: "అదనపు గమనికలు...", kn: "ಹೆಚ್ಚುವರಿ ಟಿಪ್ಪಣಿಗಳು..." },
  "Update Incentive": { en: "Update Incentive", hi: "प्रोत्साहन अपडेट करें", te: "ప్రోత్సాహకాన్ని నవీకరించండి", kn: "ಪ್ರೋತ್ಸಾಹಧನ ನವೀಕರಿಸಿ" },
  "Create Incentive": { en: "Create Incentive", hi: "प्रोत्साहन बनाएँ", te: "ప్రోత్సాహకం సృష్టించండి", kn: "ಪ್ರೋತ್ಸಾಹಧನ ರಚಿಸಿ" },
  "Export Incentives": { en: "Export Incentives", hi: "प्रोत्साहन निर्यात करें", te: "ప్రోత్సాహకాలను ఎగుమతి చేయండి", kn: "ಪ್ರೋತ್ಸಾಹಧನ ರಫ್ತು ಮಾಡಿ" },
  "No incentives found for": { en: "No incentives found for", hi: "इसके लिए कोई प्रोत्साहन नहीं मिला", te: "ఇదికి ఎలాంటి ప్రోత్సాహకాలు కనబడలేదు", kn: "ಇದಕ್ಕಾಗಿ ಯಾವುದೇ ಪ್ರೋತ್ಸಾಹಧನ ಕಂಡುಬಂದಿಲ್ಲ" },
  "Click \"Add Incentive\" to create one.": { en: "Click \"Add Incentive\" to create one.", hi: "एक नया बनाने के लिए \"Add Incentive\" पर क्लिक करें।", te: "కొత్తదాన్ని సృష్టించడానికి \"Add Incentive\" పై క్లిక్ చేయండి.", kn: "ಹೊಸದನ್ನು ರಚಿಸಲು \"Add Incentive\" ಕ್ಲಿಕ್ ಮಾಡಿ." },
  "Please select an instructor.": { en: "Please select an instructor.", hi: "कृपया एक प्रशिक्षक चुनें।", te: "దయచేసి ఒక శిక్షకుడిని ఎంచుకోండి.", kn: "ದಯವಿಟ್ಟು ಒಬ್ಬ ಪ್ರಶಿಕ್ಷಕರನ್ನು ಆಯ್ಕೆ ಮಾಡಿ." },
  "Please select a date.": { en: "Please select a date.", hi: "कृपया तारीख चुनें।", te: "దయచేసి ఒక తేదీని ఎంచుకోండి.", kn: "ದಯವಿಟ್ಟು ದಿನಾಂಕ ಆಯ್ಕೆ ಮಾಡಿ." },
  "Amount must be at least Rs1400. Only lessons with Rs1400+ are eligible for incentives.": { en: "Amount must be at least Rs1400. Only lessons with Rs1400+ are eligible for incentives.", hi: "राशि कम से कम Rs1400 होनी चाहिए। केवल Rs1400+ वाले पाठ ही प्रोत्साहन के लिए योग्य हैं।", te: "మొత్తం కనీసం Rs1400 ఉండాలి. Rs1400+ ఉన్న పాఠాలకే ప్రోత్సాహకం వర్తిస్తుంది.", kn: "ಮೊತ್ತ ಕನಿಷ್ಠ Rs1400 ಇರಬೇಕು. Rs1400+ ಇರುವ ಪಾಠಗಳಿಗಷ್ಟೇ ಪ್ರೋತ್ಸಾಹಧನ ಲಭ್ಯ." },
  "Please select payment mode.": { en: "Please select payment mode.", hi: "कृपया भुगतान माध्यम चुनें।", te: "దయచేసి చెల్లింపు విధానాన్ని ఎంచుకోండి.", kn: "ದಯವಿಟ್ಟು ಪಾವತಿ ವಿಧಾನ ಆಯ್ಕೆ ಮಾಡಿ." },
  "Incentive updated successfully.": { en: "Incentive updated successfully.", hi: "प्रोत्साहन सफलतापूर्वक अपडेट किया गया।", te: "ప్రోత్సాహకం విజయవంతంగా నవీకరించబడింది.", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಯಶಸ್ವಿಯಾಗಿ ನವೀಕರಿಸಲಾಗಿದೆ." },
  "Incentive created successfully.": { en: "Incentive created successfully.", hi: "प्रोत्साहन सफलतापूर्वक बनाया गया।", te: "ప్రోత్సాహకం విజయవంతంగా సృష్టించబడింది.", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಯಶಸ್ವಿಯಾಗಿ ರಚಿಸಲಾಗಿದೆ." },
  "Incentive deleted successfully.": { en: "Incentive deleted successfully.", hi: "प्रोत्साहन सफलतापूर्वक हटाया गया।", te: "ప్రోత్సాహకం విజయవంతంగా తొలగించబడింది.", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಯಶಸ್ವಿಯಾಗಿ ಅಳಿಸಲಾಗಿದೆ." },
  "Incentive approved successfully.": { en: "Incentive approved successfully.", hi: "प्रोत्साहन सफलतापूर्वक स्वीकृत हुआ।", te: "ప్రోత్సాహకం విజయవంతంగా ఆమోదించబడింది.", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಯಶಸ್ವಿಯಾಗಿ ಅನುಮೋದಿಸಲಾಗಿದೆ." },
  "Incentive rejected successfully.": { en: "Incentive rejected successfully.", hi: "प्रोत्साहन सफलतापूर्वक अस्वीकृत हुआ।", te: "ప్రోత్సాహకం విజయవంతంగా తిరస్కరించబడింది.", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಯಶಸ್ವಿಯಾಗಿ ತಿರಸ್ಕರಿಸಲಾಗಿದೆ." },
  "Incentive marked as paid successfully.": { en: "Incentive marked as paid successfully.", hi: "प्रोत्साहन को भुगतान के रूप में चिन्हित किया गया।", te: "ప్రోత్సాహకం చెల్లించబడినట్లు గుర్తించబడింది.", kn: "ಪ್ರೋತ್ಸಾಹಧನವನ್ನು ಪಾವತಿಸಲಾಗಿದೆ ಎಂದು ಗುರುತಿಸಲಾಗಿದೆ." },
  "Delete Incentive": { en: "Delete Incentive", hi: "प्रोत्साहन हटाएँ", te: "ప్రోత్సాహకాన్ని తొలగించండి", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಅಳಿಸಿ" },
  "Are you sure you want to delete this incentive? This action cannot be undone.": { en: "Are you sure you want to delete this incentive? This action cannot be undone.", hi: "क्या आप वाकई इस प्रोत्साहन को हटाना चाहते हैं? यह क्रिया वापस नहीं होगी।", te: "ఈ ప్రోత్సాహకాన్ని తొలగించాలని ఖచ్చితంగా అనుకుంటున్నారా? ఈ చర్యను తిరిగి మార్చలేరు.", kn: "ಈ ಪ್ರೋತ್ಸಾಹಧನವನ್ನು ಅಳಿಸಲು ಖಚಿತವೇ? ಈ ಕ್ರಿಯೆಯನ್ನು ಹಿಂದಕ್ಕೆ ಪಡೆಯಲು ಸಾಧ್ಯವಿಲ್ಲ." },
  "Error loading incentives:": { en: "Error loading incentives:", hi: "प्रोत्साहन लोड करने में त्रुटि:", te: "ప్రోత్సాహకాలను లోడ్ చేయడంలో లోపం:", kn: "ಪ್ರೋತ್ಸಾಹಧನ ಲೋಡ್ ಮಾಡಲು ದೋಷ:" },
  "January": { en: "January", hi: "जनवरी", te: "జనవరి", kn: "ಜನವರಿ" },
  "February": { en: "February", hi: "फ़रवरी", te: "ఫిబ్రవరి", kn: "ಫೆಬ್ರವರಿ" },
  "March": { en: "March", hi: "मार्च", te: "మార్చి", kn: "ಮಾರ್ಚ್" },
  "April": { en: "April", hi: "अप्रैल", te: "ఏప్రిల్", kn: "ಏಪ್ರಿಲ್" },
  "May": { en: "May", hi: "मई", te: "మే", kn: "ಮೇ" },
  "June": { en: "June", hi: "जून", te: "జూన్", kn: "ಜೂನ್" },
  "July": { en: "July", hi: "जुलाई", te: "జూలై", kn: "ಜುಲೈ" },
  "August": { en: "August", hi: "अगस्त", te: "ఆగస్టు", kn: "ಆಗಸ್ಟ್" },
  "September": { en: "September", hi: "सितंबर", te: "సెప్టెంబర్", kn: "ಸೆಪ್ಟೆಂಬರ್" },
  "October": { en: "October", hi: "अक्टूबर", te: "అక్టోబర్", kn: "ಅಕ್ಟೋಬರ್" },
  "November": { en: "November", hi: "नवंबर", te: "నవంబర్", kn: "ನವೆಂಬರ್" },
  "December": { en: "December", hi: "दिसंबर", te: "డిసెంబర్", kn: "ಡಿಸೆಂಬರ್" },
  "All": { en: "All", hi: "सभी", te: "అన్ని", kn: "ಎಲ್ಲಾ" },
  "Booking Operations": { en: "Booking Operations", hi: "बुकिंग संचालन", te: "బుకింగ్ కార్యకలాపాలు", kn: "ಬುಕಿಂಗ್ ಕಾರ್ಯಾಚರಣೆಗಳು" },
  "Bookings Management": { en: "Bookings Management", hi: "बुकिंग प्रबंधन", te: "బుకింగ్స్ నిర్వహణ", kn: "ಬುಕಿಂಗ್ ನಿರ್ವಹಣೆ" },
  "Export Bookings": { en: "Export Bookings", hi: "बुकिंग निर्यात करें", te: "బుకింగ్స్ ఎగుమతి", kn: "ಬುಕಿಂಗ್ ರಫ್ತು" },
  "Create New Booking": { en: "Create New Booking", hi: "नई बुकिंग बनाएँ", te: "కొత్త బుకింగ్ సృష్టించండి", kn: "ಹೊಸ ಬುಕಿಂಗ್ ರಚಿಸಿ" },
  "Search booking ID, horse, or client...": { en: "Search booking ID, horse, or client...", hi: "बुकिंग आईडी, घोड़ा या ग्राहक खोजें...", te: "బుకింగ్ ఐడి, గుర్రం లేదా కస్టమర్‌ను వెతకండి...", kn: "ಬುಕಿಂಗ್ ಐಡಿ, ಕುದುರೆ ಅಥವಾ ಗ್ರಾಹಕ ಹುಡುಕಿ..." },
  "Edit Booking": { en: "Edit Booking", hi: "बुकिंग संपादित करें", te: "బుకింగ్‌ను సవరించండి", kn: "ಬುಕಿಂಗ್ ಸಂಪಾದಿಸಿ" },
  "Cancel Booking": { en: "Cancel Booking", hi: "बुकिंग रद्द करें", te: "బుకింగ్ రద్దు చేయండి", kn: "ಬುಕಿಂಗ್ ರದ್ದುಗೊಳಿಸಿ" },
  "Save Booking": { en: "Save Booking", hi: "बुकिंग सहेजें", te: "బుకింగ్ సేవ్ చేయండి", kn: "ಬುಕಿಂಗ್ ಉಳಿಸಿ" },
  "Create Booking": { en: "Create Booking", hi: "बुकिंग बनाएँ", te: "బుకింగ్ సృష్టించండి", kn: "ಬುಕಿಂಗ್ ರಚಿಸಿ" },
  "Booking Date *": { en: "Booking Date *", hi: "बुकिंग तारीख *", te: "బుకింగ్ తేదీ *", kn: "ಬುಕಿಂಗ್ ದಿನಾಂಕ *" },
  "Booking Time *": { en: "Booking Time *", hi: "बुकिंग समय *", te: "బుకింగ్ సమయం *", kn: "ಬುಕಿಂಗ್ ಸಮಯ *" },
  "Select ride type": { en: "Select ride type", hi: "राइड प्रकार चुनें", te: "రైడ్ రకాన్ని ఎంచుకోండి", kn: "ರೈಡ್ ಪ್ರಕಾರ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Select inside or outside": { en: "Select inside or outside", hi: "अंदर या बाहर चुनें", te: "లోపల లేదా బయట ఎంచుకోండి", kn: "ಒಳಗೆ ಅಥವಾ ಹೊರಗೆ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Select slot": { en: "Select slot", hi: "स्लॉट चुनें", te: "స్లాట్ ఎంచుకోండి", kn: "ಸ್ಲಾಟ್ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Select instructor": { en: "Select instructor", hi: "प्रशिक्षक चुनें", te: "శిక్షకుడిని ఎంచుకోండి", kn: "ಪ್ರಶಿಕ್ಷಕರನ್ನು ಆಯ್ಕೆ ಮಾಡಿ" },
  "Select payment source": { en: "Select payment source", hi: "भुगतान स्रोत चुनें", te: "చెల్లింపు మూలాన్ని ఎంచుకోండి", kn: "ಪಾವತಿ ಮೂಲ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Customer or guest name": { en: "Customer or guest name", hi: "ग्राहक या अतिथि का नाम", te: "కస్టమర్ లేదా అతిథి పేరు", kn: "ಗ್ರಾಹಕ ಅಥವಾ ಅತಿಥಿಯ ಹೆಸರು" },
  "Client phone number": { en: "Client phone number", hi: "ग्राहक फोन नंबर", te: "కస్టమర్ ఫోన్ నంబర్", kn: "ಗ್ರಾಹಕ ಫೋನ್ ಸಂಖ್ಯೆ" },
  "Leave empty for null": { en: "Leave empty for null", hi: "null के लिए खाली छोड़ें", te: "null కోసం ఖాళీగా వదిలేయండి", kn: "null ಗಾಗಿ ಖಾಲಿ ಬಿಡಿ" },
  "No previous ride bookings found for this horse.": { en: "No previous ride bookings found for this horse.", hi: "इस घोड़े के लिए कोई पिछली राइड बुकिंग नहीं मिली।", te: "ఈ గుర్రానికి ముందు రైడ్ బుకింగ్స్ కనబడలేదు.", kn: "ಈ ಕುದುರೆಗೆ ಹಿಂದಿನ ರೈಡ್ ಬುಕಿಂಗ್‌ಗಳು ಕಂಡುಬಂದಿಲ್ಲ." },
  "outing(s)": { en: "outing(s)", hi: "राइड", te: "రైడ్‌లు", kn: "ಸವಾರಿ(ಗಳು)" },
  "Membership booking": { en: "Membership booking", hi: "सदस्यता बुकिंग", te: "మెంబర్షిప్ బుకింగ్", kn: "ಸದಸ್ಯತ್ವ ಬುಕಿಂಗ್" },
  "Membership package": { en: "Membership package", hi: "सदस्यता पैकेज", te: "మెంబర్షిప్ ప్యాకేజ్", kn: "ಸದಸ್ಯತ್ವ ಪ್ಯಾಕೇಜ್" },
  "Total ridings": { en: "Total ridings", hi: "कुल राइड्स", te: "మొత్తం రైడ్లు", kn: "ಒಟ್ಟು ಸವಾರಿ" },
  "No. of members": { en: "No. of members", hi: "सदस्यों की संख्या", te: "సభ్యుల సంఖ్య", kn: "ಸದಸ್ಯರ ಸಂಖ್ಯೆ" },
  "Package amount": { en: "Package amount", hi: "पैकेज राशि", te: "ప్యాకేజ్ మొత్తం", kn: "ಪ್ಯಾಕೇಜ್ ಮೊತ್ತ" },
  "GST amount": { en: "GST amount", hi: "GST राशि", te: "GST మొత్తం", kn: "GST ಮೊತ್ತ" },
  "Pick booking date": { en: "Pick booking date", hi: "बुकिंग तारीख चुनें", te: "బుకింగ్ తేదీ ఎంచుకోండి", kn: "ಬುಕಿಂಗ್ ದಿನಾಂಕ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Pick booking time": { en: "Pick booking time", hi: "बुकिंग समय चुनें", te: "బుకింగ్ సమయం ఎంచుకోండి", kn: "ಬುಕಿಂಗ್ ಸಮಯ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Pick date": { en: "Pick date", hi: "तारीख चुनें", te: "తేదీ ఎంచుకోండి", kn: "ದಿನಾಂಕ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Pick start time": { en: "Pick start time", hi: "प्रारंभ समय चुनें", te: "ప్రారంభ సమయం ఎంచుకోండి", kn: "ಪ್ರಾರಂಭ ಸಮಯ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Pick end time": { en: "Pick end time", hi: "समाप्ति समय चुनें", te: "ముగింపు సమయం ఎంచుకోండి", kn: "ಅಂತಿಮ ಸಮಯ ಆಯ್ಕೆ ಮಾಡಿ" },
  "Require photo evidence": { en: "Require photo evidence", hi: "फोटो प्रमाण आवश्यक", te: "ఫోటో సాక్ష్యం అవసరం", kn: "ಫೋಟೋ ಸಾಕ್ಷ್ಯ ಅಗತ್ಯ" },
  "Add guest details": { en: "Add guest details", hi: "अतिथि विवरण जोड़ें", te: "అతిథి వివరాలు జోడించండి", kn: "ಅತಿಥಿ ವಿವರಗಳನ್ನು ಸೇರಿಸಿ" },
  "Add booking details": { en: "Add booking details", hi: "बुकिंग विवरण जोड़ें", te: "బుకింగ్ వివరాలు జోడించండి", kn: "ಬುಕಿಂಗ್ ವಿವರಗಳನ್ನು ಸೇರಿಸಿ" },
  "Submitting...": { en: "Submitting...", hi: "सबमिट हो रहा है...", te: "సమర్పిస్తోంది...", kn: "ಸಲ್ಲಿಸಲಾಗುತ್ತಿದೆ..." },
  "Submit for Approval": { en: "Submit for Approval", hi: "अनुमोदन हेतु भेजें", te: "ఆమోదానికి పంపండి", kn: "ಅನುಮೋದನೆಗಾಗಿ ಕಳುಹಿಸಿ" },
  "Photo Evidence": { en: "Photo Evidence", hi: "फोटो प्रमाण", te: "ఫోటో సాక్ష్యం", kn: "ಫೋಟೋ ಸಾಕ್ಷ್ಯ" },
  "Change Photo": { en: "Change Photo", hi: "फोटो बदलें", te: "ఫోటో మార్చండి", kn: "ಫೋಟೋ ಬದಲಿಸಿ" },
  "Click to Upload Photo": { en: "Click to Upload Photo", hi: "फोटो अपलोड करने के लिए क्लिक करें", te: "ఫోటో అప్లోడ్ చేయడానికి క్లిక్ చేయండి", kn: "ಫೋಟೋ ಅಪ್‌ಲೋಡ್ ಮಾಡಲು ಕ್ಲಿಕ್ ಮಾಡಿ" },
  "Close (ESC)": { en: "Close (ESC)", hi: "बंद करें (ESC)", te: "మూసివేయండి (ESC)", kn: "ಮುಚ್ಚಿ (ESC)" },
  "Task Evidence": { en: "Task Evidence", hi: "कार्य प्रमाण", te: "పని సాక్ష్యం", kn: "ಕಾರ್ಯ ಸಾಕ್ಷ್ಯ" },
  "Tap outside to close": { en: "Tap outside to close", hi: "बंद करने के लिए बाहर टैप करें", te: "మూసేందుకు బయట ట్యాప్ చేయండి", kn: "ಮುಚ್ಚಲು ಹೊರಗೆ ಟ್ಯಾಪ್ ಮಾಡಿ" },
  "Accommodation booking": { en: "Accommodation booking", hi: "आवास बुकिंग", te: "వసతి బుకింగ్", kn: "ವಸತಿ ಬುಕಿಂಗ್" },
  "Stable booking": { en: "Stable booking", hi: "स्टेबल बुकिंग", te: "స్టేబుల్ బుకింగ్", kn: "ಸ್ಟೇಬಲ್ ಬುಕಿಂಗ್" },
  "Evidence Required": { en: "Evidence Required", hi: "प्रमाण आवश्यक", te: "సాక్ష్యం అవసరం", kn: "ಸಾಕ್ಷ್ಯ ಅಗತ್ಯ" },
  "Critical Window": { en: "Critical Window", hi: "महत्वपूर्ण समय", te: "ముఖ్యమైన సమయం", kn: "ಗಂಭೀರ ಅವಧಿ" },
  "Supplies Ready": { en: "Supplies Ready", hi: "सामग्री तैयार", te: "సరఫరాలు సిద్ధంగా ఉన్నాయి", kn: "ಸರಬರಾಜು ಸಿದ್ಧ" },
  "Arena Booked": { en: "Arena Booked", hi: "अरीना बुक", te: "అరేనా బుక్ చేయబడింది", kn: "ಅರೇನಾ ಬುಕ್ ಆಗಿದೆ" },
  "Vitals Review": { en: "Vitals Review", hi: "वाइटल समीक्षा", te: "వైటల్స్ సమీక్ష", kn: "ವೈಟಲ್ಸ್ ಪರಿಶೀಲನೆ" },
  "Standard Flow": { en: "Standard Flow", hi: "सामान्य प्रवाह", te: "సాధారణ ప్రవాహం", kn: "ಸಾಮಾನ್ಯ ಪ್ರವಾಹ" },
  "No Time Set": { en: "No Time Set", hi: "समय सेट नहीं", te: "సమయం సెట్ చేయలేదు", kn: "ಸಮಯ ಹೊಂದಿಸಲಾಗಿಲ್ಲ" },
  "Where": { en: "Where", hi: "कहाँ", te: "ఎక్కడ", kn: "ಎಲ್ಲಿ" },
  "Client": { en: "Client", hi: "ग्राहक", te: "కస్టమర్", kn: "ಗ್ರಾಹಕ" },
  "Lead/Groom": { en: "Lead/Groom", hi: "लीड/ग्रूम", te: "లీడ్/గ్రూమ్", kn: "ಲೀಡ್/ಗ್ರೂಮ್" },
  "Package": { en: "Package", hi: "पैकेज", te: "ప్యాకేజ్", kn: "ಪ್ಯಾಕೇಜ್" },
  "No slot": { en: "No slot", hi: "कोई स्लॉट नहीं", te: "స్లాట్ లేదు", kn: "ಸ್ಲಾಟ್ ಇಲ್ಲ" },
  "Payment": { en: "Payment", hi: "भुगतान", te: "చెల్లింపు", kn: "ಪಾವತಿ" },
  "Unpaid": { en: "Unpaid", hi: "अवैतनिक", te: "చెల్లించలేదు", kn: "ಪಾವತಿಸಿಲ್ಲ" },
  "Guest": { en: "Guest", hi: "अतिथि", te: "అతిథి", kn: "ಅತಿಥಿ" },
  "Lead Price": { en: "Lead Price", hi: "लीड कीमत", te: "లీడ్ ధర", kn: "ಲೀಡ್ ಬೆಲೆ" },
  "Room Price (w/ Tax)": { en: "Room Price (w/ Tax)", hi: "कमरे की कीमत (कर सहित)", te: "గది ధర (పన్నుతో)", kn: "ಕೊಠಡಿ ಬೆಲೆ (ತೆರಿಗೆಯೊಂದಿಗೆ)" },
  "Booking ID": { en: "Booking ID", hi: "बुकिंग आईडी", te: "బుకింగ్ ఐడి", kn: "ಬುಕಿಂಗ್ ಐಡಿ" },
  "Booking Type": { en: "Booking Type", hi: "बुकिंग प्रकार", te: "బుకింగ్ రకం", kn: "ಬುಕಿಂಗ್ ಪ್ರಕಾರ" },
  "Client / Guest": { en: "Client / Guest", hi: "ग्राहक / अतिथि", te: "కస్టమర్ / అతిథి", kn: "ಗ್ರಾಹಕ / ಅತಿಥಿ" },
  "Lead/Groom Name": { en: "Lead/Groom Name", hi: "लीड/ग्रूम नाम", te: "లీడ్/గ్రూమ్ పేరు", kn: "ಲೀಡ್/ಗ್ರೂಮ್ ಹೆಸರು" },
  "Assigned To": { en: "Assigned To", hi: "असाइन किया गया", te: "కేటాయించినవారు", kn: "ನಿಯೋಜಿಸಲಾಗಿದೆ" },
  "Assigned Role": { en: "Assigned Role", hi: "असाइन भूमिका", te: "కేటాయించిన పాత్ర", kn: "ನಿಯೋಜಿತ ಪಾತ್ರ" },
  "Category": { en: "Category", hi: "श्रेणी", te: "వర్గం", kn: "ವರ್ಗ" },
  "Ride Type": { en: "Ride Type", hi: "राइड प्रकार", te: "రైడ్ రకం", kn: "ರೈಡ್ ಪ್ರಕಾರ" },
  "Where To Go": { en: "Where To Go", hi: "कहाँ जाना है", te: "ఎక్కడికి వెళ్లాలి", kn: "ಎಲ್ಲಿ ಹೋಗಬೇಕು" },
  "Scheduled Time": { en: "Scheduled Time", hi: "निर्धारित समय", te: "షెడ్యూల్ సమయం", kn: "ನಿಗದಿತ ಸಮಯ" },
  "Payment Status": { en: "Payment Status", hi: "भुगतान स्थिति", te: "చెల్లింపు స్థితి", kn: "ಪಾವತಿ ಸ್ಥಿತಿ" },
  "Membership Booking": { en: "Membership Booking", hi: "सदस्यता बुकिंग", te: "మెంబర్షిప్ బుకింగ్", kn: "ಸದಸ್ಯತ್ವ ಬುಕಿಂಗ್" },
  "Package Name": { en: "Package Name", hi: "पैकेज नाम", te: "ప్యాకేజ్ పేరు", kn: "ಪ್ಯಾಕೇಜ್ ಹೆಸರು" },
  "No. of Ridings": { en: "No. of Ridings", hi: "राइड्स की संख्या", te: "రైడ్ల సంఖ్య", kn: "ಸವಾರಿಗಳ ಸಂಖ್ಯೆ" },
  "No bookings to download": { en: "No bookings to download", hi: "डाउनलोड करने के लिए कोई बुकिंग नहीं", te: "డౌన్‌లోడ్ చేసేందుకు బుకింగ్స్ లేవు", kn: "ಡೌನ್‌ಲೋಡ್ ಮಾಡಲು ಯಾವುದೇ ಬುಕಿಂಗ್‌ಗಳಿಲ್ಲ" },
  "Approve": { en: "Approve", hi: "स्वीकृत करें", te: "ఆమోదించండి", kn: "ಅನುಮೋದಿಸಿ" },
  "Reject": { en: "Reject", hi: "अस्वीकृत करें", te: "తిరస్కరించండి", kn: "ತಿರಸ್ಕರಿಸಿ" },
  "Mark as Paid": { en: "Mark as Paid", hi: "भुगतान के रूप में चिन्हित करें", te: "చెల్లించబడిందిగా గుర్తించండి", kn: "ಪಾವತಿಸಲಾಗಿದೆ ಎಂದು ಗುರುತಿಸಿ" },
  "Accommodation Booking": { en: "Accommodation Booking", hi: "आवास बुकिंग", te: "వసతి బుకింగ్", kn: "ವಸತಿ ಬುಕಿಂಗ್" },
  "Cash": { en: "Cash", hi: "नकद", te: "నగదు", kn: "ನಗದು" },
  "Card": { en: "Card", hi: "कार्ड", te: "కార్డ్", kn: "ಕಾರ್ಡ್" },
  "Bank Transfer": { en: "Bank Transfer", hi: "बैंक ट्रांसफर", te: "బ్యాంక్ ట్రాన్స్‌ఫర్", kn: "ಬ್ಯಾಂಕ್ ವರ್ಗಾವಣೆ" },
  "Cheque": { en: "Cheque", hi: "चेक", te: "చెక్", kn: "ಚೆಕ್" },
  "Other": { en: "Other", hi: "अन्य", te: "ఇతర", kn: "ಇತರೆ" },
  "Normal Riding": { en: "Normal Riding", hi: "सामान्य राइडिंग", te: "సాధారణ రైడింగ్", kn: "ಸಾಮಾನ್ಯ ಸವಾರಿ" },
  "Casual Rides": { en: "Casual Rides", hi: "सामान्य सवारी", te: "క్యాజువల్ రైడ్లు", kn: "ಕ್ಯಾಶುಯಲ್ ರೈಡ್ಸ್" },
  "Fun Rides": { en: "Fun Rides", hi: "मज़ेदार राइड्स", te: "ఫన్ రైడ్స్", kn: "ಮನರಂಜನಾ ಸವಾರಿಗಳು" },
  "Pony Ride": { en: "Pony Ride", hi: "पोनी राइड", te: "పోనీ రైడ్", kn: "ಪೋನಿ ಸವಾರಿ" },
  "Hack": { en: "Hack", hi: "हैक", te: "హాక్", kn: "ಹ್ಯಾಕ್" },
  "Inside": { en: "Inside", hi: "अंदर", te: "లోపల", kn: "ಒಳಗೆ" },
  "Outside": { en: "Outside", hi: "बाहर", te: "బయట", kn: "ಹೊರಗೆ" },
};
...
export const I18nProvider = ({ children }) => {
  ...
  const t = (key) => {
    ...
    for (const candidate of normalizedCandidates) {
      if (extraTranslations[candidate]?.[lang]) {
        return extraTranslations[candidate][lang];
      }
